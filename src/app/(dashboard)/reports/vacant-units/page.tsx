...
export default function VacantUnitsReportPage() {
  ...
  useEffect(() => {
    fetch('/api/reports/vacant-units')
      .then((res) => res.json())
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-bold">تقرير الوحدات الفارغة</h2>
      <div className="text-sm text-gray-500">عدد الوحدات الفارغة: {data.length}</div>
